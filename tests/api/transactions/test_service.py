...
from app.api.accounts.failures import Failures as AccountFailures
from app.api.exceptions import ApiException
from app.api.messages import daily_withdraw_limit
from app.api.transactions.service import deposit
from app.api.transactions.service import get_today_withdraws
from app.api.transactions.service import get_transactions
...
class ServiceTests(BaseTest):
    ...
    @patch('app.api.transactions.service.get_today_withdraws')
