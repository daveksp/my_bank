...
from app.api.accounts.schema import BalanceSchema
from app.api.accounts.schema import AccountSchema
from app.api.accounts.schema import StatementSchema
...
class AccountsResource(Resource):
    ...
    def post(self):
        ...
        account = account_schema.load(request.json or {})
    ...
    def get(self, account_id):
        ...
        response = balance_schema.dump(account)
...
class StatementsResource(Resource):
    ...
    def get(self, account_id):
        ...
        response = statement_schema.dump(account)
        return make_response(jsonify(response), 200)
